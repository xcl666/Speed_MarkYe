...
#define PRODUCT_ID      0x7327
#define DEVICE_VER      0x0005
#define MANUFACTURER    TXWD
#define PRODUCT         Speed
#define DESCRIPTION      plus OLED display and buzzer.
...
#define MATRIX_ROW_PINS { F1, F0, D4, F5, F6, F7}
#define MATRIX_COL_PINS {B6, D6, D7, B4, B5, B0, B1}
